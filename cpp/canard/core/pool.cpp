...
//template Pool<Function>::Ptr Pool<Function>::create<>(FunctionPtr, Function::Dependencies);
//template Pool<Specialization>::Ptr Pool<Specialization>::create<>(FunctionPtr, std::vector<FunctionPtr>, FunctionPtr, Function::Dependencies);
