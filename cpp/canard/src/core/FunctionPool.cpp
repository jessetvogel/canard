...
FunctionPtr FunctionPool::create_Type() {
    // Reserve a Function
    Function *f = reserve();
    // Initialize as Type
    f->init();
    // Return a FunctionPtr
    return {this, f};
}

FunctionPtr FunctionPool::create_function(const FunctionPtr &type, FunctionParameters parameters) {
    // Reserve a Function
    Function *f = reserve();
    // Set Function values
...
FunctionPtr FunctionPool::create_specialization(const FunctionPtr &type,
                                                FunctionParameters parameters,
                                                const FunctionPtr &base,
                                                std::vector<FunctionPtr> arguments) {
    // Reserve a Function
    Function *f = reserve();
    // Set Function values
